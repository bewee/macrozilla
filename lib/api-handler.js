...
class MacrozillaAPIHandler extends APIHandler {
  constructor(addonManager) {
    ...
    this.addondb.open().then(() => {
      ...
      this.config = config;
      this.dbhandler = new DBHandler(`${this.userProfile.dataDir}/${this.packageName}/db.sqlite3`, this.config.log_limit_time, this.config.log_limit_num);
  ...
  listClasses() {
    return Object.keys(this.macrohandler.classes);
  }
