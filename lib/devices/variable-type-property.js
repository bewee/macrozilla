...
class VariableTypeProperty extends Property {
  constructor(device, variable_obj, path_obj, value) {
    ...
    this.setCachedValueAndNotify(this.jsTypeToEnumType(typeof value));
  }
  ...
  setValue(value) {
    return new Promise(((resolve, reject) => {
      super.setValue(value).then(async (updatedValue) => {
        ...
        this.device.macrozilla.dbhandler.updateVariableValue(this.variable_id, JSON.stringify(nvalue));
